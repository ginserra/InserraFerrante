angular.module("appServer").controller("workController", ['$scope','$http','$mdDialog','$window','$timeout',
    function ($scope,$http,$mdDialog,$window,$timeout) {
        ...
        function getWorksType(){
            $http.get('http://localhost/server1/php_server/works/getWorksType.php')
                .then(function(response) {
                    ...
                    console.log("GETWORKTYPE",response.data);
        ...
        $scope.updateDescription= function () {
            ...
            $http.post('http://localhost/server1/php_server/works/updateDescription.php', payload, {
                headers: {
        ...
        function updateWorkType(newArrayWorkType) {
            ...
            $http.post('http://localhost/server1/php_server/works/updateWorksType.php', newArrayWorkType, {
                headers: {
                    'Content-Type': 'application/json; charset=utf-8'
                }
            }).then(function(data, status, headers, config) {
        ...
        function removeWorkType(id_type) {
            ...
            $http.post('http://localhost/server1/php_server/works/deleteWorkType.php', id_type, {
                headers: {
                    'Content-Type': 'application/json; charset=utf-8'
                }
            }).then(function(data, status, headers, config) {
