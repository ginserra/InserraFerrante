angular.module("appServer").controller("servicesController", ['$scope','$http','fileReader','$timeout','$compile','$location','$anchorScroll','servicesServices',
    function ($scope,$http, fileReader,$timeout,$compile, $location, $anchorScroll,servicesServices) {
    ...
    .directive('servicediv', function($location,$anchorScroll,$http,$window,servicesServices) {
        return {
            scope: {
                counter: '=',
                callback: '&'
